...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _loadSettings() async {
    ...
    final savedEmail =
        prefs.getString('user_email') ?? 'rezagasem.82@gmail.com';
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          'نسخه 2.1.0 | توسعه‌دهنده: رضا قاسمی',
                          style: TextStyle(
                            fontSize: 13,
                            color: Colors.grey.shade600,
                          ),
...
class _DeliveryScreenState extends State<DeliveryScreen> {
  ...
  // ==================== صفحه بارنامه جدید (BottomSheet) ====================

  Future<void> _showAddManifestDialog(
      {DeliveryManifest? targetManifest}) async {
    ...
    bool isEditing = targetManifest != null;
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                isEditing
                                    ? 'ویرایش بارنامه شماره ${targetManifest!.number}'
                                    : 'بارنامه جدید',
                                style: const TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                            ...
                            children: [
                              Expanded(
                                ...
                                child: TextFormField(
                                  ...
                                  onChanged: (value) {
                                    final found = _productDatabase.firstWhere(
                                      (p) => p.barcode == value,
                                      orElse: () => ProductDatabaseItem(
                                          barcode: '',
                                          name: '',
                                    ...
                                    if (found.barcode.isNotEmpty) {
                                      nameCtrl.text = found.name;
                                      setSheetState(() {});
                                      _showSuccessMessage(
                                          '✅ کالا از بانک اطلاعاتی پیدا شد');
                                    }
                                  },
                                ),
                              ),
                            ...
                            child: FilledButton.icon(
                              ...
                              onPressed: () {
                                ...
                                if (isEditing) {
                                  ...
                                  _addSmartLog(
                                      '➕ کالا "${name}" به بارنامه شماره ${targetManifest!.number} اضافه شد');
                                  _showSuccessMessage('کالا اضافه شد ✅');
                                } else {
                                  final manifestNumber =
                                      _getNextManifestNumber();
                                  ...
                                  _addSmartLog(
                                      '📋 بارنامه شماره $manifestNumber با کالا "${name}" ثبت شد');
                                  _showSuccessMessage(
        ...
        children: [
          ...
          if (_isSearching) ...[
            ...
            GridView.count(
              ...
              children: [
                _buildToolCard(
                  ...
                  title: 'بارنامه',
                  subtitle: 'ثبت بارنامه جدید',
                  iconColor: Colors.blue,
                  onTap: () => _showAddManifestDialog(),
                ),
                _buildToolCard(
            ...
            if (_savedManifests.isNotEmpty) ...[
              ...
              const SizedBox(height: 8),
              ..._savedManifests.reversed.take(5).map(
                    (manifest) => GestureDetector(
                      onTap: () => _viewManifest(manifest),
                      child: _buildManifestCard(
                        _savedManifests.indexOf(manifest),
                      ),
                    ),
                  ),
            ],
...
class DeliveryManifestsScreen extends StatefulWidget {
  final List<DeliveryManifest> manifests;
  final Future<void> Function() onNewManifest;
  final ValueChanged<DeliveryManifest> onDelete;
  final ValueChanged<DeliveryManifest> onEdit;
  final ValueChanged<DeliveryManifest> onOpen;

  const DeliveryManifestsScreen({
    super.key,
    required this.manifests,
    required this.onNewManifest,
  ...
  @override
  State<DeliveryManifestsScreen> createState() =>
      _DeliveryManifestsScreenState();
}

class _DeliveryManifestsScreenState extends State<DeliveryManifestsScreen> {
  @override
  Widget build(BuildContext context) {
    final manifests = widget.manifests.reversed.toList();
    return Scaffold(
      appBar: AppBar(
        title: const Text('📦 بارنامه‌ها'),
        centerTitle: true,
      ),
      body: manifests.isEmpty
          ? Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: const [
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text('بارنامه شماره ${m.number}',
                        style: const TextStyle(fontWeight: FontWeight.bold)),
                    subtitle:
                        Text('تاریخ: ${m.date}\nکالاها: ${m.items.length}'),
                    isThreeLine: true,
...
class _SalesInvoicesScreenState extends State<SalesInvoicesScreen> {
  ...
  String _displayPrice(int price) => '${_formatPrice(price)} ریال';
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text('فاکتور شماره $number',
                                            style: const TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 16)),
                                        Text('تاریخ: ${first.date}',
                                            style: const TextStyle(
                                                fontSize: 12,
                                                color: Colors.grey)),
                                      ],
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _saveSettings() async {
    ...
    widget.onSettingsChanged(
        _darkMode, _emailController.text, _nameController.text);
  }
